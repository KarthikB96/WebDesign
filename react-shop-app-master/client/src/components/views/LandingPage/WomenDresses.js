...
import item1 from '../../../../src/images/dress1.jpg';
import item2 from '../../../../src/images/dress2.jpg';
import item3 from '../../../../src/images/dress3.jpg';
import item4 from '../../../../src/images/dress4.jpg';
import item5 from '../../../../src/images/dress5.jpg';
export default function WomenDresses() {
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">White Dress</h1>
      </div>
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Blue Dress</h1>
      </div>
      <div className="dtc tr">
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Floral Dress</h1>
      </div>
      <div className="dtc tr">
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Peach Dress</h1>
      </div>
      <div className="dtc tr">
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Green Dress</h1>
      </div>
      <div className="dtc tr">
