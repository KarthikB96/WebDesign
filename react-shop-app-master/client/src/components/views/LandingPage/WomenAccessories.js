...
import item1 from '../../../../src/images/women1.jpg';
import item2 from '../../../../src/images/women2.jpg';
import item3 from '../../../../src/images/women3.jpg';
import item4 from '../../../../src/images/women4.jpg';
import item5 from '../../../../src/images/women5.jpg';
import item6 from '../../../../src/images/women6.jpg';
export default function WomenAccessories() {
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Bag</h1>
      </div>
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Neckless</h1>
      </div>
      <div className="dtc tr">
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Belt</h1>
      </div>
      <div className="dtc tr">
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Chain</h1>
      </div>
      <div className="dtc tr">
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Shades</h1>
      </div>
      <div className="dtc tr">
...
<article className="br2 ba dark-gray b--black-10 mv4 w-100 w-50-m w-25-l mw5 center" style={{display:'block', float:'left',marginLeft:'90px'}}>
  <img src={item6} className="db w-100 br2 br--top" alt="Photo of a kitten looking menacing." />
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Earrings</h1>
      </div>
      <div className="dtc tr">
        <h2 className="f5 mv0">$149</h2>
      </div>
