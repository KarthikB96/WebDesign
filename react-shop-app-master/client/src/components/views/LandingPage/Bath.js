...
import item1 from '../../../../src/images/bath1.jpg';
import item2 from '../../../../src/images/bath2.jpg';
import item3 from '../../../../src/images/bath3.jpg';
import item4 from '../../../../src/images/bath4.jpg';
...
export default function Bath() {
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Towel Set</h1>
      </div>
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Bath Mat</h1>
      </div>
      <div className="dtc tr">
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Stuffs</h1>
      </div>
      <div className="dtc tr">
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Cleaning Brush</h1>
      </div>
      <div className="dtc tr">
