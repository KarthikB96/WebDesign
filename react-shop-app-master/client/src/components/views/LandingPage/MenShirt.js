...
import item1 from '../../../../src/images/shirt1.jpg';
import item2 from '../../../../src/images/shirt2.jpg';
import item3 from '../../../../src/images/shirt3.jpg';
import item4 from '../../../../src/images/shirt4.jpg';
import item5 from '../../../../src/images/shirt5.jpg';
export default function MenShirt() {
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">White Shirt</h1>
      </div>
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Black Shirt</h1>
      </div>
      <div className="dtc tr">
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Olive shirt</h1>
      </div>
      <div className="dtc tr">
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Light Blue Shirt</h1>
      </div>
      <div className="dtc tr">
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Gray shirt</h1>
      </div>
      <div className="dtc tr">
