...
import item1 from '../../../../src/images/menshoe1.jpg';

import item2 from '../../../../src/images/menshoe2.jpg';
import item3 from '../../../../src/images/menshoe3.jpg';
import item4 from '../../../../src/images/menshoe4.jpg';
import item5 from '../../../../src/images/menshoe5.jpg';
export default function MenShoes() {
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Sports Shoes</h1>
      </div>
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Black Shoes</h1>
      </div>
      <div className="dtc tr">
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Casuals</h1>
      </div>
      <div className="dtc tr">
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Formal Shoes</h1>
      </div>
      <div className="dtc tr">
  ...
  <div className="pa2 ph3-ns pb3-ns">
    <div className="dt w-100 mt1">
      <div className="dtc">
        <h1 className="f5 f4-ns mv0">Boots</h1>
      </div>
      <div className="dtc tr">
